...
#ifndef HYBRID_AUTOMATON_INTERFACES__SRV__DETAIL__RESET__FUNCTIONS_H_
#define HYBRID_AUTOMATON_INTERFACES__SRV__DETAIL__RESET__FUNCTIONS_H_
 ...
 * calls
 * hybrid_automaton_interfaces__srv__Reset_Request__init().
...
/**
 * It calls
 * hybrid_automaton_interfaces__srv__Reset_Request__fini()
 ...
 * hybrid_automaton_interfaces__srv__Reset_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * hybrid_automaton_interfaces__srv__Reset_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hybrid_automaton_interfaces__srv__Reset_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hybrid_automaton_interfaces
...
/**
 * It calls
 * hybrid_automaton_interfaces__srv__Reset_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_hybrid_automaton_interfaces
...
/**
 * It allocates the memory for the array and calls
 * hybrid_automaton_interfaces__srv__Reset_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hybrid_automaton_interfaces
...
/**
 * It calls
 * hybrid_automaton_interfaces__srv__Reset_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HYBRID_AUTOMATON_INTERFACES__SRV__DETAIL__RESET__FUNCTIONS_H_
