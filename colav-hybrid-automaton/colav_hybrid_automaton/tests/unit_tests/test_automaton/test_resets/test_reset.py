from colav_hybrid_automaton.automaton.resets import Reset
import pytest
...
def test_reset_creation_and_calls():
    class TestReset(Reset):
        ...
        def __init__(self, **init_kwargs):
            ...
            reset_targets = [
                {'name': 'output_x', 'type': float},
                {'name': 'output_y', 'type': int}
            ]
