...
class CounterReset(ResetInterface):
    ...
    def _evaluate(self, **state_kwargs) -> Dict[str, Any]:
        ...
        return {"counter_value": new_count, "max_reached": max_reached}


def main():
    # Instantiate CounterReset with initialization parameters
    resetter = CounterReset(increment_value=2, max_count=5, reset_on_max=True)
    ...
    reset_output = resetter(
        current_count=current_count_msg, trigger_event=trigger_event_msg
    )
