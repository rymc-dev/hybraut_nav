...
class DynamicsInterface(HybridComponentInterface):
    ...
    def __repr__(self) -> str:
        return f"{self.__class__.__name__}(output_type={self._output_spec.__name__}, initialized={self.is_initialized})"

    def __str__(self) -> str:
        return f"Hybrid Automaton Dynamics: {self.__class__.__name__} (Output: {self._output_spec.__name__})"