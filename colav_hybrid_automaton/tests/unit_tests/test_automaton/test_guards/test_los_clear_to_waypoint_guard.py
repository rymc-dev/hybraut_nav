...
@pytest.mark.parametrize(
    ...
    [
        # Test Case 1: No state args passed
        ({}, KeyError, "No args -> KeyError('agent state not given')"),
        
        # Test Case 2: Missing agent_state
        ({
            'waypoints_state': ROSWaypointsState(),
            'unsafe_set_state': ROSUnsafeSetState(),
            'obstacles_state': ROSObstaclesState()
        ...
        # Test Case 3: Wrong type for agent_state
        ({
            'agent_state': "wrong_type",
            'waypoints_state': ROSWaypointsState(),
            'unsafe_set_state': ROSUnsafeSetState(),
            'obstacles_state': ROSObstaclesState()
        }, TypeError, "Wrong agent_state type -> KeyError('agent state given not current type')"),
        
        # Test Case 4: Missing waypoints_state
        ({
            'agent_state': ROSAgentState(),
            'unsafe_set_state': ROSUnsafeSetState(),
            'obstacles_state': ROSObstaclesState()
        ...
        # Test Case 5: Wrong type for waypoints_state
        ({
            'agent_state': ROSAgentState(),
            'waypoints_state': "wrong_type",
            'unsafe_set_state': ROSUnsafeSetState(),
            'obstacles_state': ROSObstaclesState()
        }, TypeError, "Wrong waypoints_state type -> KeyError('waypoints state given not correct type.')"),
        
        # Test Case 6: Missing unsafe_set_state
        ({
            'agent_state': ROSAgentState(),
            'waypoints_state': ROSWaypointsState(),
            'obstacles_state': ROSObstaclesState()
        ...
        # Test Case 7: Wrong type for unsafe_set_state
        ({
            'agent_state': ROSAgentState(),
            'waypoints_state': ROSWaypointsState(),
            'unsafe_set_state': "wrong_type",
            'obstacles_state': ROSObstaclesState()
        }, TypeError, "Wrong unsafe_set_state type -> KeyError('unsafe set input not of correct type ROSUnsafeSet')"),
        
        # Test Case 8: Missing obstacles_state
        ({
            'agent_state': ROSAgentState(),
            'waypoints_state': ROSWaypointsState(),
            'unsafe_set_state': ROSUnsafeSetState()
        ...
        # Test Case 9: Wrong type for obstacles_state
        ({
            'agent_state': ROSAgentState(),
            'waypoints_state': ROSWaypointsState(),
            'unsafe_set_state': ROSUnsafeSetState(),
            'obstacles_state': "wrong_type"
        }, TypeError, "Wrong obstacles_state type -> KeyError('obstacles state not of the correct type ROSObstaclesState')"),
    ]
)
