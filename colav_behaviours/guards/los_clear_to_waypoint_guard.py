...
from nodes._internal.utils import euclidean_distance
...
class LOSClearToWaypointGuard(GuardInterface):
    """
...
if __name__ == '__main__':
    ...
    guard: GuardInterface = LOSClearToWaypointGuard(**init_kwargs)
