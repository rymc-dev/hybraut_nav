...
class StatePublisher:
    ...
    def publish_state(self):
        ...
        msg = AutomatonRuntimeState(
           ...
           time_since_last_transition = self.gen_time_to_duration(time_since_last_transition),
    ...
    def gen_time_to_duration(self, duration_sec: float) -> Duration:
        ...
        msg.nanosec = int((duration_sec - msg.sec) * 1_000_000_000)  # fractional part to ns
        return msg
