...
def main(**kwargs):
    ...
    event_publisher: Publisher = node.create_publisher(
        TransitionEvent, "/automaton/transition_events", qos_profile=QOS, callback_group=CB_GROUP
    )
    ...
    engine_state_tracker: EngineAutomatonStateTracker = EngineAutomatonStateTracker(
